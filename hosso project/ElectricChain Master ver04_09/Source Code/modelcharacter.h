...
public:
	...
	//static std::string GetModelName(CHARACTER_TYPE const modeltype,int nCntParts)	{ return  m_pModelCharacterList[modeltype]->pModelInfoList[nCntParts]->getname; };			//モデル名取得
