...
std::vector<CModelInfo::MODELNAME> CModelInfo::m_aModelFileNameList =
{
	...
	{ "data/MODEL/Map/Block.x" ,			MODEL_MAPOBJECT_BLOCK },				//ブロック
	{ "data/MODEL/Map/Sphere.x" ,			MODEL_MAPOBJECT_SPHERE },				//スフィア
	{ "data/MODEL/Map/box.x" ,				MODEL_MAPOBJECT_BOX },					//ボックス
	{ "data/MODEL/Map/head.x" ,				MODEL_MAPOBJECT_HEAD },					//カエル頭
