...
public:
	...
	void SetParameter(CHARACTER_TYPE modeltype, PARAM_TYPE m_Paramtype,std::shared_ptr<CCharacter> MyPtr);			//パラメータ設定
	...
	CHARACTER_TYPE	GetModelType()							{ return m_modeltype; };							//モデルの種類取得
...
private:
	...
	CHARACTER_TYPE m_modeltype;								//モデルの種類
