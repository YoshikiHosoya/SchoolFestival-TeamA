...
//マクロ
//------------------------------------------------------------------------------
#define BACK_COLOR (D3DCOLOR_RGBA(50, 50, 50, 0))
...
HRESULT CRenderer::Init(HINSTANCE hInstance, HWND hWnd, BOOL bWindow)
{
	...
	// ステンシルバッファの設定
	m_pD3DDevice->SetRenderState(D3DRS_STENCILFUNC, D3DCMP_NOTEQUAL);		//ステンシルの対象
	m_pD3DDevice->SetRenderState(D3DRS_STENCILPASS, D3DSTENCILOP_REPLACE);	//ステンシルZテスト共に合格している
	m_pD3DDevice->SetRenderState(D3DRS_STENCILZFAIL, D3DSTENCILOP_KEEP);	//ステンシルに合格、Zテストに不合格
	m_pD3DDevice->SetRenderState(D3DRS_STENCILFAIL, D3DSTENCILOP_KEEP);		//ステンシルテストに不合格
...
void CRenderer::Draw()
{
	...
	m_pD3DDevice->Clear(0, NULL, (D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER | D3DCLEAR_STENCIL), BACK_COLOR, 1.0f, 0);
