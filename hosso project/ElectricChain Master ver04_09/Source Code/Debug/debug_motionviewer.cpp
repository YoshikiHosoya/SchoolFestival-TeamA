...
void CDebug_MotionViewer::ShowDebugInfo()
{
	...
	{
		CHossoLibrary::RangeLimit_Equal_Int(m_nModelType, 0, CHARACTER_MAX - 1);
	}
	//パラメータ
...
void CDebug_MotionViewer::SetGamestate(STATE gamestate)
{
	...
	if (m_State != CDebug_MotionViewer::STATE_NONE)
	{
		...
		case CDebug_MotionViewer::STATE_DEBUG:
			...
			m_pCharacter = CDebug_Character::Create((CHARACTER_TYPE)m_nModelType,(CCharacter::PARAM_TYPE)m_nParamText);
