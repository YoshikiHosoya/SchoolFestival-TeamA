...
public:
	...
	void SetDispDebugInfo(bool bDebugInfo) { m_bShowDebugInfo = bDebugInfo; };			//Imgui表示非表示設定
	bool CheckShoeDebugInfo()				{ return m_bShowDebugInfo; };				//デバッグ情報表示してるか確認
...
private:
	...
	bool				m_bDebugText;				//デバッグテキスト表示するか
	bool				m_bShowDebugInfo;			//Imgui描画するかどうか
