...
//生成
//------------------------------------------------------------------------------
std::shared_ptr<CDebug_Character> CDebug_Character::Create(MODEL_TYPE modeltype, CCharacter::PARAM_TYPE paramtype)
{
	//変数宣言
	...
	if (pCharacter)
	{
		...
		//パラメータ設定
		pCharacter->SetParameter(modeltype, paramtype,pCharacter);
