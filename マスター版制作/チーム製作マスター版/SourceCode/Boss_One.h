...
public:
	...
	struct BOSS_ONE_DATABASE
	{
		...
		D3DXVECTOR3			CollisionSize[STATE_MAX];		// 当たり判定のサイズ
		D3DXVECTOR3			GunShotOfsetPos[WEAPONTYPE_MAX];// ガンのオフセット座標
	};

	// =====================================================================================================================================================================
	// ボスのAIデータ
	// =====================================================================================================================================================================
	struct BOSS_ONE_AI_PRIORITY
	{
		std::vector<int *> nPriorityData;			// 優先度を格納する変数
		int AttackType[ATTACKTYPE_MAX];				// 優先度
	};
...
private:
	...
	float					GetVectorLength(D3DXVECTOR3 vectol);									// ベクトルの長さを計算する
	float					DotProduct(D3DXVECTOR3 vl, D3DXVECTOR3 vr);								// ベクトル内積
