// =====================================================================================================================================================================
//
// シーン2Dnewの処理 [scene2Dnew.cpp]
// Author : Sato Yoshiki
//
// =====================================================================================================================================================================
#include "scene2Dnew.h"			// インクルードファイル
#include "renderer.h"
#include "manager.h"
...
//
// =====================================================================================================================================================================
void CScene2Dnew::SetAnim(D3DXVECTOR2 UVsize, D3DXVECTOR2 UV)
{
	// 頂点情報へのポインタ
	VERTEX_2D *pVtx;
...
//
// =====================================================================================================================================================================
void CScene2Dnew::SetRadius(float fRadius)
{
	// 頂点情報へのポインタ
	VERTEX_2D *pVtx;
...
//
// =====================================================================================================================================================================
void CScene2Dnew::SetRotation(float fAngle, float fLength, float fRot)
{
	// 頂点情報へのポインタ
	VERTEX_2D *pVtx;
...
//
// =====================================================================================================================================================================
void CScene2Dnew::SetCol(D3DXCOLOR col)
{
	// 頂点情報へのポインタ
	VERTEX_2D *pVtx;
...
//
// =====================================================================================================================================================================
void CScene2Dnew::BindTexture(LPDIRECT3DTEXTURE9 pTexture)
{
	m_pTexture = pTexture;
}
...
//
// =====================================================================================================================================================================
CScene2Dnew * CScene2Dnew::Create()
{
	// 変数
	CScene2Dnew *pScene2Dnew;

	// メモリの確保
	pScene2Dnew = new CScene2Dnew;
