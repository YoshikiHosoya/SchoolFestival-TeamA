...
// 静的メンバ変数の初期化
// =====================================================================================================================================================================
BULLET_PARAM	CBullet::m_BulletParam[GUNTYPE_MAX] = {};

// =====================================================================================================================================================================
// テキストファイル名
// =====================================================================================================================================================================
char *CBullet::m_BulletFileName[GUNTYPE_MAX] =
{
...
void CBullet::Update(void)
{
	...
	m_BulletParam[0].nLife--;

	// 体力が0になったら									配列の[ 0 ]のところには銃の種類が入る
	if (m_BulletParam[0].nLife <= 0)
	{
...
void CBullet::BulletLoad()
{
	...
	for (int nCnt = 0; nCnt < GUNTYPE_MAX; nCnt++)
	{
		// ファイルを開く
