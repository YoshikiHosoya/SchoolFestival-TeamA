...
//生成処理
//------------------------------------------------------------------------------
CMultiNumber * CMultiNumber::Create(D3DXVECTOR3 pos, D3DXVECTOR3 onesize, int nValue, int nDigits, CScene::OBJ_TYPE objtype)
{
	//メモリ確保
	CMultiNumber *pMultiNumber = new CMultiNumber(objtype);
